...
to <output_dir>/<compact-timestamp>.json.gz; a timestamp collision is an error.
"""
...
def test_onefile_outputdir(tmp_path):
    ...
    assert (tmp_path / "20260612T180000Z.json.gz").exists()
...
def test_twofiles_difftimes(tmp_path):
    ...
    assert (tmp_path / "20260612T180000Z.json.gz").exists()
    assert (tmp_path / "20260612T190000Z.json.gz").exists()
